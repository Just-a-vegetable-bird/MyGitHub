...
import com.hncu.taoshu.ui.SlideMenu;
...
public class SlideMenuAdapter extends BaseExpandableListAdapter{
	...
	public SlideMenuAdapter(Context context, List<Map<String, Object>> group,
	...
	public View getChildView(int groupPosition, int childPosition,
		...
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.slidemenu_list_child, null);
		...
		holder.mChildName.setText(mChild.get(groupPosition).get(childPosition)
				.get("name").toString());
		if (childPosition == SlideMenu.mChooesId && groupPosition == 0) {
			convertView
	...
	public View getGroupView(int groupPosition, boolean isExpanded,
		...
		ViewHolder holder = null;
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.slidemenu_list_group, null);
			holder = new ViewHolder();
